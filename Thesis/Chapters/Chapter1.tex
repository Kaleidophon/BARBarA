...
Für eine \emph{allgemeinte künstliche Intelligenz}\footnote{``Artificial general intelligence (AGI) is the intelligence
...
Ersteres wird durch sog. \emph{Ontologien}, d.h. Darstellungen von Beziehungen zwischen Elementen einer Menge, modelliert.
...
\begin{figure}[h]
    ...
    \caption[Hauptstadtrelationen zwischen Wortvektoren aus (\cite{mikolov2013distributed})]{Hauptstadtrelationen
...
und \ref{AppendixB} mit detaillierten Informationen über Wortkontextvektortraining und -evaluation sowie die Bibliographie.
