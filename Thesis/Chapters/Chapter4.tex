...
angewendet und kritisch reflektiert werden sollen.\\
  ...
  \begin{table}[h]
    ...
    \begin{tabular}{@{}lllll@{}}
      ...
      \toprule
      \Romannum{1} & \textsc{Belgien} & \textsc{Anlagebank} & \textsc{Linguistik} & \textsc{gekrazt} \\
      ...
      \midrule
      \Romannum{8} & \textsc{Italien} & \textsc{Hausbank} & \textsc{Bioinformatik} & \textsc{gekrazt} \\
      ...
      \midrule
      \Romannum{22} & \textsc{Italien} & \textsc{Kreditinstitut} & \textsc{Bioinformatik} & \textsc{geritzt} \\
