...
\thesistitle{Analyse von Relationsvorhersagen im Deutschen mit Wortvektorrepräsentationen} % Your thesis title, this is used in the title and abstract, print it elsewhere with \ttitle
