...
\thesistitle{Analyse der Relationsvorhersage im Deutschen mit Wortvektoren} % Your thesis title, this is used in the title and abstract, print it elsewhere with \ttitle
